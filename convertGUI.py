...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.cancel = QtWidgets.QPushButton(self.verticalFrame, clicked = lambda: self.cancelConvert(Form))
        ...
        self.covert = QtWidgets.QPushButton(self.verticalFrame, clicked = lambda: self.createPDF())
